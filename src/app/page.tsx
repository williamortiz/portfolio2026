          ...
          <div className="gap-2 gap-y-6 flex flex-col md:flex-row justify-between">
            <div className="gap-2 flex flex-col order-2 md:order-1">
              <div className="select-none">
                <h1 className="text-3xl font-semibold tracking-tighter sm:text-4xl lg:text-5xl py-1">
                  <SplitText
                    text="Hi, I'm "
            ...
            <BlurFade delay={BLUR_FADE_DELAY} className="order-1 md:order-2">
              <Magnetic range={120} strength={0.2}>
                <Avatar className="size-24 md:size-32 border rounded-full shadow-lg ring-4 ring-muted cursor-pointer transition-transform duration-300">

...
export const DATA = {
  ...
  skills: {
    ...
    hardware: [
      ...
      { name: "Apple Macintosh Systems" },
      { name: "Wacom Drawing Tablets" },
      { name: "Linotronic Imagesetters (L300/L330)" },
      { name: "Scitex Iris Proofers (Iris 2047)" },
      { name: "Agfa Selectset Systems" },
      { name: "iPad & Mobile Test Devices" },
      { name: "DSLR & Mirrorless Cameras" },
      { name: "Darkroom & Film Development Equipment" },
      { name: "Preflight Quality Control Stations" }
    ]
  },
  navbar: [
